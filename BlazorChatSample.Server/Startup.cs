...
namespace BlazorChatSample.Server
{
    public class Startup
    {
        ...
        public static bool EnableMembering { get; internal set; }
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddMvc();
            services.AddSignalR();
            EnableMembering = Configuration.GetValue<bool>("EnableMembering");
            services.AddDbContext<DbCon>(op => op.UseSqlServer(Configuration.GetConnectionString("CN")));
